...
import net.glasslauncher.alwaysmoreitems.CraftingGridHelper;
import net.glasslauncher.alwaysmoreitems.DrawableHelper;
import net.glasslauncher.alwaysmoreitems.api.gui.ICraftingGridHelper;
...
public class CraftingRecipeCategory implements IRecipeCategory {
	...
	public CraftingRecipeCategory() {
		...
		localizedName = TranslationStorage.getInstance().get("gui.jei.category.craftingTable");
