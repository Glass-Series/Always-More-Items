...
import net.glasslauncher.alwaysmoreitems.api.gui.ITooltipCallback;
import net.glasslauncher.alwaysmoreitems.util.CycleTimer;
...
public class GuiIngredient<T> extends Screen implements IGuiIngredient<T> {
    ...
    private void drawTooltip(@Nonnull Minecraft minecraft, int mouseX, int mouseY, @Nonnull T value) {
        try {
            ...
            AMITooltipSystem.drawTooltip(tooltip, mouseX, mouseY, false);
